...
require_once XAIA_DIR . 'includes/class-xaia-budget.php';
require_once XAIA_DIR . 'includes/class-xaia-lock.php';
...
require_once XAIA_DIR . 'includes/class-xaia-maintenance.php';
...
register_activation_hook( __FILE__, array( 'XAIA_Maintenance', 'activate' ) );
register_deactivation_hook( __FILE__, array( 'XAIA_Maintenance', 'deactivate' ) );
